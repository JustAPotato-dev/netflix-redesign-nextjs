...
import { BiPlus, BiVolume, BiVolumeFull, BiVolumeMute } from 'react-icons/bi';
  ...
  return (
    ...
    >
      <>
        <button
          onClick={handleClose}
          className="modalButton absolute right-5 top-5 !z-40 h-9 w-9 boder-none bg-[#181818] hover:bg-[#181818]"
        >
        ...
        <div className="relative pt-[56.25%]">
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            ...
            <button className="modalButton" onClick={() => setMuted(!muted)}>
              {!muted ? <BiVolumeFull className="h-6 w-6" /> : <BiVolumeMute className="h-6 w-6" />}
            </button>
          </div>
        </div>
